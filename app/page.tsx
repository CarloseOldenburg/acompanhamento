              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-wrap justify-between gap-4">
                  ...
                  <div className="flex items-center gap-3 flex-wrap">
                    {isClient && process.env.NEXT_PUBLIC_GOOGLE_CLIENT_ID && process.env.NEXT_PUBLIC_GOOGLE_API_KEY ? (
                      ...
                      <Button
                        ...
                        title="Google Sheets integration requires API configuration"
                      >
                        <AlertCircle className="w-4 h-4 mr-2" />
                        {isClient ? "Google Sheets (Não Configurado)" : "Carregando..."}
                      </Button>
                    )}
